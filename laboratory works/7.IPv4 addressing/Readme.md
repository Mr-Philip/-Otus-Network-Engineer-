...
Количество бит подсети мы высчтываем из префиксов маски исходной 255.255.255.0 (/24) и новой  255.255.255.224 (/27) получаем 3 бита подсети  
...
Количетсво созданных подсетей высчтываем из префикса маски /32-n, где n новая маска подсети
Проблема 1:  
