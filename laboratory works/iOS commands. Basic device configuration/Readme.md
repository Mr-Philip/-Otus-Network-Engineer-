...
Отвеча. на вопрос:  
Какое имя присвоено образу Cisco IOS?# **Лабораторная работа. Базовая настройка коммутатора **
...
![Шаг](https://github.com/Mr-Philip/-Otus-Network-Engineer-/blob/f18eaa391e5dacc8354e27989fec37525ccf7687/laboratory%20works/iOS%20commands.%20Basic%20device%20configuration/pics/Step2(a).png)  
```
no ip domain-lookup
hostname S1
...
![Шаг](https://github.com/Mr-Philip/-Otus-Network-Engineer-/blob/f18eaa391e5dacc8354e27989fec37525ccf7687/laboratory%20works/iOS%20commands.%20Basic%20device%20configuration/pics/Step2(b).png)  
...
![Шаг](https://github.com/Mr-Philip/-Otus-Network-Engineer-/blob/f18eaa391e5dacc8354e27989fec37525ccf7687/laboratory%20works/iOS%20commands.%20Basic%20device%20configuration/pics/Step2(c).png)  
```
...
![Шаг](https://github.com/Mr-Philip/-Otus-Network-Engineer-/blob/f18eaa391e5dacc8354e27989fec37525ccf7687/laboratory%20works/iOS%20commands.%20Basic%20device%20configuration/pics/Step2(d).png)  
...
![Шаг](https://github.com/Mr-Philip/-Otus-Network-Engineer-/blob/f18eaa391e5dacc8354e27989fec37525ccf7687/laboratory%20works/iOS%20commands.%20Basic%20device%20configuration/pics/Step2(f).png)  
### Часть 3. Проверка сетевых подключений  
...
Какова полоса пропускания этого интерфейса? MTU 1500 bytes, BW 100000 Kbit, DLY 1000000 useс     
...
b.	Выберите сервер Telnet и указываю адрес управления SVI для подключения к S1. использую Пароль: cisco.
c.	После ввода пароля cisco оказываюсь в командной строке пользовательского режима. Для перехода в исполнительский режим EXEC ввожу команду enable и использую секретный пароль class.
d.	Сохраняю конфигурацию.
e.	Завершаю сеанс Telnet, введя exit.
Вопросы:
Отвечаю на вопросы для повторения  
